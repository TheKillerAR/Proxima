...
<form action="ContoServlet" method="post">
	...
	<input type='hidden' name="funzione" value="inserisci">
		...
		<h4>Inserisci il saldo</h4>
		<input type="text" name="saldo" /> <br><br>
		
		<h4>Inserisci la data di inizio</h4>
		<input type="text" name="datainizio" /> <br><br>
				
		<input type="submit"value="Conferma" /> <br>
		
---------------------------------------------------------------------------

<h2>Aggiorna conto</h2>
